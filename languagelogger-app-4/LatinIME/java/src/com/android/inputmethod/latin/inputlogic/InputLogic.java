    ...
    private void handleFunctionalEvent(final Event event, final InputTransaction inputTransaction,
        ...
        switch (event.mKeyCode) {
            ...
            case Constants.CODE_SHIFT_ENTER:
                ...
                inputTransaction.setDidAffectContents();
                break;
            case Constants.CODE_SUGGESTION_MODE:
                //Note: Switching to suggestion mode keyboard should be handled elsewhere
                break;
            case Constants.CODE_ALPHA_FROM_SUGGESTION_MODE:
                //Note: Switching back from suggestion mode keyboard should be handled elsewhere
                break;
            default:

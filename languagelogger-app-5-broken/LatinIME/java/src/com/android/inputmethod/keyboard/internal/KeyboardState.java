...
public final class KeyboardState {
    ...
    private boolean mIsSuggestionMode;
    ...
    static final class SavedKeyboardState {
        ...
        public boolean mIsSuggestionMode;
    ...
    public void onSaveKeyboardState() {
        ...
        state.mIsSuggestionMode = mIsSuggestionMode;
        if (mIsAlphabetMode) {
    ...
    private void setSuggestionModeKeyboard() {
        Log.i(TAG,"setSuggestionModeKeyboard");
        mIsAlphabetMode = false;
        mIsEmojiMode = false;
        mIsSuggestionMode = true;
        mRecapitalizeMode = RecapitalizeStatus.NOT_A_RECAPITALIZE_MODE;
        mAlphabetShiftState.setShiftLocked(false);
        mSwitchActions.setSuggestionModeKeyboard();
    }
    ...
    public void onEvent(final Event event, final int autoCapsFlags, final int recapitalizeMode) {
        ...
        if (Constants.isLetterCode(code)) {
            ...
            setAlphabetKeyboard(autoCapsFlags, recapitalizeMode);
        } else if (code == Constants.CODE_SUGGESTION_MODE) {
            setSuggestionModeKeyboard();
        } else if (code == Constants.CODE_ALPHA_FROM_SUGGESTION_MODE) {
            setAlphabetKeyboard(autoCapsFlags, recapitalizeMode);
        }
    }

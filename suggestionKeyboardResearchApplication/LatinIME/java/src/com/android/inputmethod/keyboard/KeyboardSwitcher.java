...
import com.android.inputmethod.keyboard.suggestionmode.SuggestionModeKeyboardView;
import com.android.inputmethod.latin.InputView;
import com.android.inputmethod.latin.LatinIME;
import com.example.suggestionkeyboardresearchapplication.R;import com.android.inputmethod.latin.RichInputMethodManager;
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public static SuggestionModeKeyboardView mSuggestionPagesView;
    ...
    private void setMainKeyboardFrame(
        ...
        mSuggestionPagesView.setVisibility(View.GONE);
        //mSuggestionPagesView.stopSuggestionGenerationSequence();
    }
    ...
    @Override
    public void setSuggestionModeKeyboard() {
        Log.i(TAG,"setSuggestionModeKeyboard");
        final Keyboard keyboard = mKeyboardLayoutSet.getKeyboard(KeyboardId.ELEMENT_ALPHABET);
        mMainKeyboardFrame.setVisibility(View.GONE);

        mKeyboardView.setVisibility(View.GONE);
        mSuggestionPagesView.startSuggestionGenerationSequence();
        mSuggestionPagesView.setVisibility(View.VISIBLE);

    }


    /*
    Used as a bridge between SuggestionModeKeyboardHeaderView and SuggestionModeKeyboardView to change the active layout
     */
    public void updateSuggestionKeyboard(int direction) {
        mSuggestionPagesView.updateSuggestionGenerationPhase(direction);
    }
    ...
    public enum KeyboardSwitchState {
        ...
        SUGGESTION(KeyboardId.ELEMENT_SUGGESTION_PAGE1),
        OTHER(-1);
    ...
    public KeyboardSwitchState getKeyboardSwitchState() {
        ...
        } else if (isShowingSuggestionPages()) {
            return KeyboardSwitchState.SUGGESTION;
    ...
    public void onToggleKeyboard(@Nonnull final KeyboardSwitchState toggleState) {
        ...
        if (currentState == toggleState) {
            ...
            if (toggleState == KeyboardSwitchState.EMOJI) {
                Log.i("Riley Testing","Is this where the setEmojiKeyboard method is invoked?");
                setEmojiKeyboard();
            } else if (toggleState == KeyboardSwitchState.SUGGESTION) {
                setSuggestionModeKeyboard();
            } else {
                mEmojiPalettesView.stopEmojiPalettes();
                mEmojiPalettesView.setVisibility(View.GONE);
                mSuggestionPagesView.stopSuggestionGenerationSequence();
    ...
    public boolean isShowingSuggestionPages() {
        return mSuggestionPagesView != null && mSuggestionPagesView.isShown();
    }
    ...
    public View onCreateInputView(final boolean isHardwareAcceleratedDrawingEnabled) {
        ...
        mSuggestionPagesView = (SuggestionModeKeyboardView) mCurrentInputView.findViewById(
                R.id.suggestion_mode_view);
        ...
        mSuggestionPagesView.setHardwareAcceleratedDrawingEnabled(
                isHardwareAcceleratedDrawingEnabled);
        mSuggestionPagesView.setKeyboardActionListener(mLatinIME);

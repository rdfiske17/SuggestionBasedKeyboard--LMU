...
import com.example.suggestionkeyboardresearchapplication.R;import com.android.inputmethod.latin.RichInputMethodSubtype;
...
public final class MainKeyboardView extends KeyboardView implements DrawingProxy,
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        Log.i(TAG,"Any Touch Event just occurred at " + System.currentTimeMillis());
        if (getKeyboard() == null) {
            return false;
        }

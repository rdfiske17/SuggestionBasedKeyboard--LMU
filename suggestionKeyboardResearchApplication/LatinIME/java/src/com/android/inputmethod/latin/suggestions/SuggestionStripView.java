...
//import com.example.suggestionkeyboardresearchapplication.R;import com.android.inputmethod.latin.SuggestedWords;
...
public final class SuggestionStripView extends RelativeLayout implements OnClickListener,
    ...
    private final ImageButton mSuggestionModeKey;
    ...
    public SuggestionStripView(final Context context, final AttributeSet attrs,
        ...
        mSuggestionModeKey = (ImageButton)findViewById(R.id.research_private_mode_button);
        ...
        final Drawable iconSuggestionMode = keyboardAttr.getDrawable(R.styleable.Keyboard_iconPrivateModeKeyActive);
        ...
        mSuggestionModeKey.setImageDrawable(iconSuggestionMode);
        mSuggestionModeKey.setOnClickListener(this);
    }
    ...
    public void updateVisibility(final boolean shouldBeVisible, final boolean isFullscreenMode) {
        ...
        mSuggestionModeKey.setVisibility(currentSettingsValues.mShowsSuggestionModeKey ? VISIBLE : INVISIBLE);
    }
    ...
    public void onClick(final View view) {
        ...
        if (view == mSuggestionModeKey) {
            mListener.onCodeInput(Constants.CODE_SUGGESTION_MODE,
                    Constants.SUGGESTION_STRIP_COORDINATE, Constants.SUGGESTION_STRIP_COORDINATE,
                    false /* isKeyRepeat */);
            return;
        }

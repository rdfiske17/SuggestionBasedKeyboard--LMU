...
public final class Constants {
    ...
    public static final int CODE_SUGGESTION_MODE = -16;
    public static final int CODE_ALPHA_FROM_SUGGESTION_MODE = -17;
    ...
    public static String printableCode(final int code) {
        ...
        case CODE_SUGGESTION_MODE: return "suggestionMode";
        case CODE_ALPHA_FROM_SUGGESTION_MODE: return "alpha";
